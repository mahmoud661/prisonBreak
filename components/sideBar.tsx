...
export default function SideBar() {
  ...
  return (
    <>
      ...
      <div
        className="md:hidden fixed inset-0 bg-black/50 z-30 backdrop-blur-sm hidden"
        id="mobile-nav-overlay"
      ></div>

      {/* Sidebar - different on mobile vs desktop */}
      <aside
        className="fixed left-0 top-0 h-screen bg-zinc-100 dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-800 
      ...
      >
        <div className="p-4  border-zinc-200 dark:border-zinc-800">
          <Link href="/" className="flex items-center space-x-2">
            ...
            <h1 className="text-xl font-bold tracking-wider text-red-600">
              PRISON BREAK
            </h1>
          </Link>
